...
<head>
    @if(App::isLocale('ar'))
        ...
        <link href="/admin/rtl/assets/css/scrollspyNav.css" rel="stylesheet" type="text/css"/>
        <link href="/admin/rtl/assets/css/components/tabs-accordian/custom-accordions.css" rel="stylesheet"
              type="text/css"/>
    ...
    @if (App::isLocale('en'))
        ...
        <!--  BEGIN setting page  -->
        <link href="/admin/assets/css/scrollspyNav.css" rel="stylesheet" type="text/css"/>
        <link href="/admin/assets/css/components/tabs-accordian/custom-accordions.css" rel="stylesheet"
              type="text/css"/>
        <!--  END setting page  -->
        <link href="/admin/assets/css/scrollspyNav.css" rel="stylesheet" type="text/css"/>
